...
![NUMT Analysis](results/NUMT_comprehensive_analysis.png)
...
1. Identify discordant pairs where one read maps to nuclear genome (chr1-22, X, Y) and mate maps to mitochondrial genome
